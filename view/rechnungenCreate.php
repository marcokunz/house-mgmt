        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <select class="form-control">
                    <option name="typ" value="<?php echo !empty($rechnungen["typ"]) ? $rechnungen["typ"] : ''; ?>">Heizkosten</option>
                    <option name="typ" value="<?php echo !empty($rechnungen["typ"]) ? $rechnungen["typ"] : ''; ?>">Nebenkosten</option>
                </select>
