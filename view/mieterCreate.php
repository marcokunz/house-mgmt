        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <select class="form-control" required name="quadratmeter">
                    ...
                    <option value="45">45 m2 - Wohnung 1.1</option>
                    <option value="51">51 m2 - Wohnung 1.2</option>
                    <option value="56">56 m2 - Wohnung 1.3</option>
                    <option value="63">63 m2 - Wohnung 2.1</option>
                    <option value="70">70 m2 - Wohnung 2.2</option>
                    <option value="77">77 m2 - Wohnung 2.3</option>
                    <option value="95">95 m2 - Wohnung 2.4</option>
                    <option value="101">101 m2 - Wohnung 3.1</option>
                    <option value="115">115 m2 - Wohnung 4.1</option>
                    <option value="120">120 m2 - Wohnung 5.1</option>
                    <option value="122">122 m2 - Wohnung 6.1</option>
                    <option value="130">130 m2 - Wohnung 7.1</option>
                </select>
            </div>
        </div>
