...
<div class="container">
    ...
    <?php endif; ?>
        ...
        <div class="col-md-4" style="background-color:#DDF4F3; border-color: white; border-width: thick; border-style: solid; border-radius: 10px">
            <h4 class="text-left" style="background-color: lightgrey"><?php echo $mietertabelle->getVorname()." ".$mietertabelle->getNachname() ;?></h4>
